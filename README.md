...
3 · Weather input. The closing list also displays the Singapore two-hour rain forecast from data.gov.sg. Managers can select a forecast area, while the forecast remains an additional input rather than an automatic markdown recommendation.
...
* `assessment.md` — criteria-based self-assessment of the front end and back end, including evidence and reflection on the Human-AI collaboration.
* `REFLECTION.md` — reflection from the earlier Problem Set 1 build.
